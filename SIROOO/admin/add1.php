				...
				<div class="ad-side-content">
					<div class="container">
						<div class="uploadsecs">
							<div class="uploadsec active"><a href="add1.php">First Section</a></div>
							<div class="uploadsec"><a href="add2.php">First Section</a></div>
							<div class="uploadsec"><a href="add3.php">First Section</a></div>
						</div>
						<div class="form" id="form">
						  <form method="post" action="add1.php" align="center" enctype="multipart/form-data">
...
<?php
     ...
     if (isset($_POST['submit'])) {
        ...
        $FileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
     	...
     	$sql="INSERT INTO `items`(`name`, `price`, `imgpath`) VALUES ('$Name','$Institute','$filename')";
     	$match="SELECT * FROM `items` WHERE `imgpath`='$filename'";
